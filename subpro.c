...
int cmp_name(const void* a, const void* b) {
    return strcmp(((pInfo)a)->name, ((pInfo)b)->name);
}  // cmp_name

int cmp_sex(const void* a, const void* b) {
    return strcmp(((pInfo)a)->sex, ((pInfo)b)->sex);
}  // cmp_sex
...
int cmp_tele(const void* a, const void* b) {
    return strcmp(((pInfo)a)->tele, ((pInfo)b)->tele);
}  // cmp_tele

int cmp_addr(const void* a, const void* b) {
    return strcmp(((pInfo)a)->addr, ((pInfo)b)->addr);
}  // cmp_addr
